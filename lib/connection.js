...
import { loadContactStore, bindContactStoreEvents } from './contactStore.js'
...
export async function createConnection() {
  ...
  // ─── Bind persistent contact store (disimpan di sessions/) ──
...
export async function startBot() {
  ...
  // Load contact store dari sessions/ (persistent)
