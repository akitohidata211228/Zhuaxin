// ═══════════════════════════════════════════════════════════════
//  lib/contactStore.js — Persistent Contact Store
//
//  Disimpan di: sessions/contact-store.json
//  → Ikut terhapus saat folder sessions/ dihapus
//  → TIDAK masuk GitHub (sessions/ ada di SKIP list backup.js)
//
//  Menyimpan:
//    - contacts : { jid → { name, notify } }
//    - lidMap   : { lid → jid }   (mapping LID ke nomor asli)
// ═══════════════════════════════════════════════════════════════
...
// Path file ikut folder sessions → otomatis terhapus bareng sessions
