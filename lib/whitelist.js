// ═══════════════════════════════════════════════
//  lib/whitelist.js — Whitelist / Trusted User DB
//  Format: data/whitelist.json
//  { numbers: ["628xxx", ...], mode: "on"|"off" }
//
//  mode "on"  → hanya whitelist + owner yang bisa pakai bot
//  mode "off" → semua orang bisa pakai bot (whitelist diabaikan)
// ═══════════════════════════════════════════════
