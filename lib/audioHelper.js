...
/**
 * Konversi buffer audio apapun (mp3, m4a, dll) ke ogg/opus
 * @param {Buffer} inputBuf - Buffer audio input
 * @returns {Promise<Buffer>} Buffer ogg/opus siap kirim ke channel
 */
